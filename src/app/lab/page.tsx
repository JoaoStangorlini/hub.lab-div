...
function LabContent() {
    ...
    return (
        <MainLayoutWrapper>
            ...
            {/* Navegação Horizontal (Tabs) Restored */}
            <div className="mb-8 border-b border-gray-200 dark:border-gray-800 overflow-x-auto pb-4 custom-scrollbar filter backdrop-blur-md sticky top-16 z-20 bg-gray-50/80 dark:bg-background-dark/80 pt-4 px-4 sm:px-0 mx-[-16px] sm:mx-0">
                <div className="flex items-center gap-2 sm:gap-4 font-mono w-max mx-auto px-4 sm:px-8">
                    {[
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 sm:px-5 py-2.5 rounded-xl font-bold tracking-widest text-[10px] sm:text-[11px] uppercase transition-all whitespace-nowrap ${activeTab === tab.id
                                ? 'bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm ring-1 ring-gray-200 dark:ring-gray-700'
                                : 'text-gray-500 hover:bg-white/50 dark:hover:bg-gray-900/50 hover:text-gray-700 dark:hover:text-gray-300'
                                }`}
                        >
                            {tab.icon}
                            {tab.label}
